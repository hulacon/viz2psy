...
class LLStatModel(BaseModel):
    ...
    def predict(self, image: Image.Image) -> dict[str, float]:
        ...
        return {
            "llstat_luminance_mean": lum_mean,
            "llstat_luminance_std": lum_std,
            "llstat_rms_contrast": rms_contrast,
            "llstat_r_mean": r_mean,
            "llstat_r_std": r_std,
            "llstat_g_mean": g_mean,
            "llstat_g_std": g_std,
            "llstat_b_mean": b_mean,
            "llstat_b_std": b_std,
            "llstat_lab_l_mean": lab_l_mean,
            "llstat_lab_a_mean": lab_a_mean,
            "llstat_lab_b_mean": lab_b_mean,
            "llstat_saturation_mean": saturation_mean,
            "llstat_hf_energy": hf_energy,
            "llstat_lf_energy": lf_energy,
            "llstat_edge_density": edge_dens,
            "llstat_colorfulness": color_metric,
        }
